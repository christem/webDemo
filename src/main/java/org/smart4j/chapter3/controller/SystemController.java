...
public class SystemController {
    ...
    @Action("get:/")
    public View index() {
        return new View("org/smart4j/chapter3/index.jsp");
    }
    ...
    @Action("get:/login")
    public View login() {
        return new View("org/smart4j/chapter3/login.jsp");
    }
    ...
    public View loginSubmit(Param param) {
        ...
        try {
            ...
            return new View("/org/smart4j/chapter3/login");
        }
        return new View("/org/smart4j/chapter3/customer");
    }
